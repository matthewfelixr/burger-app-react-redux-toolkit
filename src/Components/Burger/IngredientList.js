...
const IngredientList = () => {
  ...
  return (
    <div>
        <ul>
            <li>Patty: {ingredient.patty} <button onClick={()=>dispatch(burgerSlice.actions.removeIngredient({ingredient:'patty'}) ) }>-</button>
                                          <button onClick={()=>dispatch(burgerSlice.actions.addIngredient({ingredient:'patty'}) ) }>+</button>
            </li>
            <li>Lettuce: {ingredient.lettuce} <button onClick={()=>dispatch(burgerSlice.actions.removeIngredient({ingredient:'lettuce'}) ) }>-</button>
                                          <button onClick={()=>dispatch(burgerSlice.actions.addIngredient({ingredient:'lettuce'}) ) }>+</button>
            </li>
            <li>Cheese: {ingredient.cheese} <button onClick={()=>dispatch(burgerSlice.actions.removeIngredient({ingredient:'cheese'}) ) }>-</button>
                                          <button onClick={()=>dispatch(burgerSlice.actions.addIngredient({ingredient:'cheese'}) ) }>+</button>
            </li>
            <li>Tomato: {ingredient.tomato} <button onClick={()=>dispatch(burgerSlice.actions.removeIngredient({ingredient:'tomato'}) ) }>-</button>
